...
layout = html.Div(
    ...
    dcc.Tab(label='Analyses', children=[
        ...
        html.Div(id='intermediate-value-analyse-macro', style={'display': 'none'})

        ]),


        dcc.Tab(label='Echantillons analysés', children=[
